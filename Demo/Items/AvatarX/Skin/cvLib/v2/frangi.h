...
#define DEFAULT_SIGMA_END 12
#define DEFAULT_SIGMA_STEP 2
#define DEFAULT_BETA_ONE 0.5
#define DEFAULT_BETA_TWO 15
...
void frangi2d(const cv::Mat &src, cv::Mat &J, cv::Mat &scale, cv::Mat &directions, frangi2d_opts_t opts,int flag);
